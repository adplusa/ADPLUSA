    ...
    try {
        ...
        if (!faq) {
            ...
            if (seoDescription !== undefined)
                faq.seoDescription = seoDescription;
            if (req.body.customHeadTags !== undefined)
                faq.customHeadTags = req.body.customHeadTags;
        }
...
export const updateAbout = async (
    ...
    try {
        ...
        if (!about) {
            ...
            if (allowLightHeading !== undefined)
                about.allowLightHeading = allowLightHeading;
            if (allowUsHeading !== undefined)
                about.allowUsHeading = allowUsHeading;
            if (allowRightHeading !== undefined)
                about.allowRightHeading = allowRightHeading;
            ...
            if (seoDescription !== undefined)
                about.seoDescription = seoDescription;
            if (customHeadTags !== undefined)
                about.customHeadTags = customHeadTags;
        }
