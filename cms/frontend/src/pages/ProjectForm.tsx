...
export default function ProjectForm() {
  ...
  const loadProject = async (slug: string) => {
    try {
      ...
      reset({
        ...
        introText: projectData.intro || projectData.introduction || projectData.introText || projectData.intro_text || projectData.summary || projectData.fullDescription || '',
        moreContent: projectData.content || projectData.moreContent || projectData.body || projectData.text || '',
        projectDetails: projectData.details || projectData.projectDetails || [],
      });
    } catch (err: any) {
  ...
  const onSubmit = useCallback(async (data: ProjectFormData) => {
    ...
    // Final attempt: Manually build payload with all fields and aliases
    const payload: { [key: string]: any } = {
      ...
      introduction: data.introText,
      content: data.moreContent,
    ...
    try {
      if (isEditMode && data._id) {
        await updateProject(data._id, payload as any);
      } else {
  ...
  const tabs: FormTab[] = [
    ...
    { id: 'details', label: 'Project Details', icon: '📋', count: detailsFields.length },
  ...
  return (
    <>
      ...
      <FormWrapper
        ...
        subtitle={isEditMode ? 'Update the project details below' : 'Fill in the details to create a new project'}
      ...
      >
          ...
          <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <FormField
                ...
                helpText={`URL: /projects/${watch('slug') || 'your-slug'}`}
              >
                <input
                  id="slug"
                  type="text"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              >
                <input
                  ...
                  type="text"
                  {...register('link')}
                  className={`w-full px-4 py-2.5 border rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors ${errors.link ? 'border-red-300 bg-red-50' : 'border-gray-300'
                    }`}
                  placeholder="https://..."
          ...
          <div className="space-y-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-500">Add key-value pairs like Location, Area, Client, etc.</p>
              </div>
              <button
                type="button"
            ...
            {detailsFields.length === 0 ? (
              <div className="text-center py-12 bg-gray-50 rounded-lg border-2 border-dashed border-gray-300">
                <p className="text-gray-500">No details yet. Click "Add Detail" to get started.</p>
                <p className="text-xs text-gray-400 mt-1">Common details: Location, Area, Year, Client</p>
              </div>
            ) : (
                ...
                {detailsFields.map((field, index) => (
                  <div key={field.id} className="flex items-center gap-3 bg-gray-50 rounded-lg p-3 border border-gray-200">
                    <div className="flex-1 grid grid-cols-2 gap-3">
                      <input
                        type="text"
                        {...register(`projectDetails.${index}.label`)}
                      ...
                      <input
                        type="text"
                        {...register(`projectDetails.${index}.value`)}
                        className="px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
        ...
        {activeTab === 'images' && (
          <div className="space-y-6">
            <div>
              <h3 className="text-lg font-medium text-gray-900 mb-2">Project Images</h3>
              <p className="text-sm text-gray-500 mb-4">
                Upload images for the project gallery. The first image will be used as the main image.
              </p>
              <Controller
                name="images"
                control={control}
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-4 mb-6">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-green-700 text-sm">
                    https://yoursite.com/projects/{watch('slug') || 'page-slug'}
                  </p>
