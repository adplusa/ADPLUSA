        ...
        try {
            ...
            reset({
                ...
                introText:
                    ...
                    projectData.intro_text ||
                    projectData.summary ||
                    projectData.fullDescription ||
                    "",
                moreContent:
                    projectData.content ||
                    projectData.moreContent ||
                    projectData.body ||
                    projectData.text ||
                    "",
                projectDetails:
                    projectData.details || projectData.projectDetails || [],
            });
        } catch (err: any) {
            setError(
                                    ...
                                    <ImageUploader
                                        ...
                                        initialImages={
                                            value?.map((img) => ({
                                                ...
                                                width: img.width,
                                                height: img.height,
                                                contentType: img.url.match(
                                                    /\.(mp4|webm|mov)$/i,
                                                )
                                                    ? "video/mp4"
                                                    : "image/jpeg", // Fallback infer
