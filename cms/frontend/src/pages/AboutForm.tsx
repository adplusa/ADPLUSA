...
export default function AboutForm() {
  ...
  const onSubmit = useCallback(async (data: AboutFormData) => {
  ...
  const tabs: FormTab[] = [
    ...
    { id: 'links', label: 'Anchor Links', icon: '🔗', count: anchorFields.length },
    { id: 'sections', label: 'Sections', icon: '📋', count: sectionFields.length },
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="mt-2 text-xs text-gray-500">
                This is the main content paragraph for the about page
              </p>
            </div>
          </div>
        )}
          ...
          <div className="space-y-6">
            <div className="flex justify-between items-center">
              <div>
                ...
                <p className="text-sm text-gray-500">Add navigation links to page sections</p>
              </div>
              <button
                type="button"
            ...
            {anchorFields.length === 0 ? (
              <div className="text-center py-12 bg-gray-50 rounded-lg border-2 border-dashed border-gray-300">
                <p className="text-gray-500">No anchor links yet. Click "Add Link" to get started.</p>
              </div>
            ) : (
              <div className="space-y-3">
                {anchorFields.map((anchor, index) => (
                  <div key={anchor.id} className="flex gap-3 items-center bg-gray-50 rounded-lg p-3 border border-gray-200">
                    <div className="flex-1">
                      <input
                        ...
                        aria-label={`Anchor link ${index + 1} label`}
                      />
                    </div>
                    <div className="flex-1">
                      <input
                        ...
                        className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                        aria-label={`Anchor link ${index + 1} target ID`}
                      />
                    </div>
                    <button
                      type="button"
          ...
          <div className="space-y-6">
            <div className="flex justify-between items-center">
              <div>
                ...
                <p className="text-sm text-gray-500">Add content sections to the about page</p>
              </div>
              <button
                type="button"
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-4 mb-6">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-gray-600 text-sm line-clamp-2">
                    {watchSeoDescription || 'Page description will appear here...'}
                  </p>
                </div>
              </div>
