...
const mainNavigation = [{ name: "Dashboard", href: "/dashboard", icon: Home }];
...
const pagesNavigation = [
    ...
    {
        name: "Main Service Page",
        href: "/dashboard/main-service-page",
        icon: Layers,
    },
    ...
    const sidebarContent = (
        <div className="flex h-full flex-col">
            ...
            <div className="border-t p-4">
                <div className="flex items-center gap-3 rounded-lg bg-muted/50 p-3 glossy-card">
