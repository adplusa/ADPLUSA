...
const getPlatformConfig = (platform: string) => {
  switch (platform.toLowerCase()) {
    case 'facebook': return { icon: Facebook, color: 'bg-[#1877F2] hover:bg-[#1877F2]/90 text-white' };
    case 'twitter': return { icon: Twitter, color: 'bg-[#1DA1F2] hover:bg-[#1DA1F2]/90 text-white' };
    case 'instagram': return { icon: Instagram, color: 'bg-[#E4405F] hover:bg-[#E4405F]/90 text-white' };
    case 'linkedin': return { icon: Linkedin, color: 'bg-[#0A66C2] hover:bg-[#0A66C2]/90 text-white' };
    case 'youtube': return { icon: Youtube, color: 'bg-[#FF0000] hover:bg-[#FF0000]/90 text-white' };
    case 'github': return { icon: Github, color: 'bg-[#181717] hover:bg-[#181717]/90 text-white' };
    case 'whatsapp': return { icon: MessageCircle, color: 'bg-[#25D366] hover:bg-[#25D366]/90 text-white' };
    case 'telegram': return { icon: Send, color: 'bg-[#0088cc] hover:bg-[#0088cc]/90 text-white' };
    case 'website': return { icon: Globe, color: 'bg-slate-800 hover:bg-slate-900 text-white' };
    default: return { icon: ExternalLink, color: 'bg-gray-100 text-gray-700 hover:bg-gray-200' };
  }
};
            ...
            {data.socialLinks.map((link: any, index: number) => {
              ...
              return link.isActive && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className={`flex items-center gap-2 px-3 py-1.5 rounded-full text-sm transition-colors ${color}`}
                >
  ...
  const renderTagPreview = () => (
    <div className="space-y-6">
      ...
      <div className="flex items-center space-x-2">
        ...
        <code className="bg-gray-100 px-2 py-1 rounded">{data.slug}</code>
      </div>
      <div className="flex items-center space-x-2">
