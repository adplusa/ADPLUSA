...
const getPlatformConfig = (platform: string) => {
    switch (platform.toLowerCase()) {
        ...
        case "instagram":
            return {
                icon: Instagram,
                color: "bg-[#E4405F] hover:bg-[#E4405F]/90 text-white",
            };
        case "linkedin":
            return {
                icon: Linkedin,
        ...
        case "youtube":
            return {
                icon: Youtube,
                color: "bg-[#FF0000] hover:bg-[#FF0000]/90 text-white",
            };
        case "github":
            return {
                icon: Github,
                color: "bg-[#181717] hover:bg-[#181717]/90 text-white",
            };
        case "whatsapp":
            return {
                icon: MessageCircle,
                ...
                <div className="pt-4 border-t border-gray-200">
                    ...
                    <div className="flex flex-wrap gap-2">
                        {data.socialLinks.map((link: any, index: number) => {
                            const { icon: Icon, color } = getPlatformConfig(
                                link.platform,
                            );
                            return (
                                link.isActive && (
