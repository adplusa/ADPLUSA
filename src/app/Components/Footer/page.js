...
import { getGeneralSettings, getContact } from "@/lib/cms-client";

const DEFAULT_FOOTER_LOGO = "/footer-logo.png";
...
const Footer = () => {
        ...
        const fetchData = async () => {
            try {
                ...
                if (settings?.footerLogo?.url) {
                    setFooterLogo(settings.footerLogo.url);
                ...
                if (contact?.socialLinks && contact.socialLinks.length > 0) {
                    setSocialLinks(contact.socialLinks.filter(link => link.isActive));
                }
            } catch (error) {
    ...
    const renderSocialIcon = (platform) => {
        switch (platform.toLowerCase()) {
            ...
            case 'twitter': return <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-twitter-x" viewBox="0 0 16 16"><path d="M12.6.75h2.454l-5.36 6.142L16 15.25h-4.937l-3.867-5.07-4.425 5.07H.316l5.733-6.57L0 .75h5.063l3.495 4.633L12.601.75Zm-.86 13.028h1.36L4.323 2.145H2.865l8.875 11.633Z" /></svg>;
            default: return <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-link-45deg" viewBox="0 0 16 16"><path d="M4.715 6.542 3.343 7.914a3 3 0 1 0 4.243 4.243l1.828-1.829A3 3 0 0 0 8.586 5.5L8 6.086a1.002 1.002 0 0 0-.154.199 2 2 0 0 1 .861 3.337L6.88 11.45a2 2 0 1 1-2.83-2.83l.793-.792a4.018 4.018 0 0 1-.128-1.287z" /><path d="M6.586 4.672A3 3 0 0 0 7.414 9.5l.775-.776a2 2 0 0 1-.896-3.346L9.12 3.55a2 2 0 1 1 2.83 2.83l-.793.792c.112.42.155.855.128 1.287l1.372-1.372a3 3 0 1 0-4.243-4.243L6.586 4.672z" /></svg>;
        }
    };
            ...
            <div className="footer">
                <div className="footer-logo">
                    ...
                    <p>
                        ...
                        Engineering
                        <br />
                        outsource fraternity across India and the United States
                        of America.
                    </p>
                </div>
                ...
                <div className="social-media">
                    {socialLinks && socialLinks.length > 0 && socialLinks.map((link, idx) => (
                        <span key={idx} className="blue-back">
