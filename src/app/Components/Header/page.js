  ...
  return (
    <div className="header">
        ...
        <div className="header-right">
          ...
          <div className="menu-color">
            <div
              ...
              onClick={() => colorChangerHandle(desktopToggleRef)}
            >
              <h3 id="on">ON</h3>
              <div className="day-night">
                <div
                  ref={desktopToggleRef}
                  className="rounder-div-changer"
                ></div>
                {/* Night & Sun Icons */}
                <svg
                  id="night"
      ...
      <div className="header-df mobile">
        <button id="ham" onClick={() => setMobileMenuOpen(!isMobileMenuOpen)}>
          {menuOpen ? (
            <svg
        ...
        <div className="menu-color">
          <div
            className="color-changer"
            onClick={() => colorChangerHandle(mobileToggleRef)}
          >
            <h3 id="on">ON</h3>
            <div className="day-night">
